            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(certificateList[index].organization, style: const TextStyle(color: accentColor2)),
                    Text(certificateList[index].date, style: const TextStyle(color: subheadingColor, fontSize: 12)),
                  ],
                ),
                ...
                Text.rich(
                  maxLines: 1,
                  TextSpan(
                      text: 'Skills : ', style: const TextStyle(color: headingColor),
                      children: [
                        TextSpan(
                          text: certificateList[index].skills, style: const TextStyle(color: bodyTextColor, overflow: TextOverflow.ellipsis),)
                      ]
                  ),),
                const SizedBox(height: defaultPadding,),
                InkWell(
